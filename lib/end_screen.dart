...
class myend extends StatefulWidget {
  const myend({super.key});

  @override
  State<myend> createState() => _myendState();
}
class _myendState extends State<myend> {
                ...
                height: 50,
                 ...
                 shape: const RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(8)) 
                           ...
                           onPressed: ()=>Navigator.push(context,MaterialPageRoute(builder: (context)=>myscreen())), 
